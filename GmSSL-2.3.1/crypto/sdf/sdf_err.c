...
static ERR_STRING_DATA SDF_str_functs[] = {
    ...
    {ERR_FUNC(SDF_F_SDF_EXTERNALDECRYPT_ECC), "SDF_ExternalDecrypt_ECC"},	//added by bruce, 0917
    {ERR_FUNC(SDF_F_SDF_EXTERNALSIGN_ECC), "SDF_EXTERNALSIGN_ECC"},			//added by bruce, 0918
