...
class PCLI : public PObject
{
  ...
  public:
    ...
    class Context : public PIndirectChannel
    {
      ...
      //@{
        ...
        /*控制光标*/
		void CsMove(int action);

		/*方向键*/
		void ArrowKey(int ch);
      ...
      protected:
		...
		int         m_xPosition;
		char     *  m_Pcommand;
		PStringList::iterator m_historyCount;
  ...
  //@{
    /**Start a command line interpreter.
       ...
       returns end of file.
      */
    void ProcessDelete(Context &context,PString &commandLine);
    virtual bool Start(
  ...
  //@}
    ...
    */
	...
	/*tabPrint*/
	int tabPrint(int CLength, PCLI::Context &context, PString &Cline);
