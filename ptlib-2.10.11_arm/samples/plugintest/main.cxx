...
PString testSo =PString("/pwlibplugindir/8168videop60_ptplugin.so");
if(pluginMgr.LoadPlugin(testSo))
	cout<<"8168videop60_ptplugin.so load success!"<<endl;
else
	cout<<"8168videop60_ptplugin.so load failed!"<<endl;
