 ...
 * $Revision: 29144 $
 * $Author: ededu $
 * $Date: 2013-02-19 14:00:55 -0600 (Tue, 19 Feb 2013) $
 */
...
class H323EndPoint : public OpalRTPEndPoint
{
  ...
  //@{
     ...
     */
	PBoolean UseGatekeeperAddress(const PString & address);
    ...
    /**Called when the gatekeeper sends a RegistrationConfirm
      */
    virtual void OnRegistrationConfirm(PString gkIp);
...
//gaoshaobo for openssl, added by lee, 20180327
//H323 Secure EndPoint
class H323SEndPoint : public H323EndPoint
{
	PCLASSINFO(H323SEndPoint, H323EndPoint);
  public:
	H323SEndPoint(OpalManager & manager)
		: H323EndPoint(manager){ }
	PString GetDefaultTransport() const{ return "tcps$:1300,tcp$";}
};
