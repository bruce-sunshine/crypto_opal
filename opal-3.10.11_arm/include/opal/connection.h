...
class OpalConnection : public PSafeObject
{
  ...
  public:
	int totalBandwidth; //dong add for bandwidth
...
//dong change for statistic
  ...
  //@{
	...
	virtual void OnDualEstablished();
  ...
  //@}
    ...
    //ys add for audio adjust
    PSafeList<OpalMediaStream> GetMediaStreams() const { return mediaStreams; }
