...
class OpalMediaFormat : public PContainer
{
  ...
  public:
	...
	void SetName(PString fmtName)  { PWaitAndSignal m(m_mutex); MakeUnique(); if (m_info != NULL) m_info->formatName = fmtName;  }
...
//dong motify for tcp/telnet control
	static const PString & DecodeBitRateOption();
...
//dong motify for tcp/telnet control
	static const PString & FrameRateOption();
...
class OpalAudioFormat : public OpalMediaFormat
{
  ...
  public:
    ...
    static const PString & AlsaInputOption();
};
...
#define OPAL_G719_48K		"G.719-48k"//gaoshaobo added
