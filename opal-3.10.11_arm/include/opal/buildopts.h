 ...
 * $Revision: 28259 $
 * $Author: rjongbloed $
 * $Date: 2012-08-28 00:01:10 -0500 (Tue, 28 Aug 2012) $
 */
...
#define OPAL_BUILD 11
#define OPAL_VERSION "3.10.11"
...
#define OPAL_PLUGIN_DIR "/usr/local/lib/opal-3.10.11"
...
/* Temporarily disabled as is currently broken, doesn't work,
    probably doesn't even compile, need to sort out API to enable/disable,
    add SDP and H.245 handling, and link into libsrtp
*/
//#undef HAS_LIBSRTP
