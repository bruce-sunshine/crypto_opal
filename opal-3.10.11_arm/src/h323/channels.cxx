...
{
PTRACE(2, "~H323Channel() 1");
  connection.SetBandwidthUsed(bandwidthUsed, 0);
PTRACE(2, "~H323Channel() 2");

  delete capability;
PTRACE(2, "~H323Channel() 3");
}
...
PBoolean H323_RealTimeChannel::OnSendingPDU(H245_H2250LogicalChannelParameters & param) const
{
  ...
  if (connection.IsH245Master() || sessionID <= H323Capability::DefaultDataSessionID || sessionID == H323Capability::DefaultH239SessionID)
...
PBoolean H323_RealTimeChannel::OnReceivedAckPDU(const H245_OpenLogicalChannelAck & ack)
{
  ...
  //dong change for h239
  if (GetSessionID() == H323Capability::DefaultH239SessionID) 
  {
	  H323ControlPDU pdu;
	  ...
	  miscindication.m_logicalChannelNumber = ack.m_forwardLogicalChannelNumber;
