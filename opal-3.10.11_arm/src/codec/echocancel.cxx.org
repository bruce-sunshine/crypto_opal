...
//	fa = fopen("recv.pcm","wb");
//	if(!fa)
//	{
//		printf ("recv.pcm File in Open Error....\n");
//	}
//	ne = fopen("send.pcm","wb");
//		if(!ne)
//		{
//			printf ("send.pcm File in Open Error....\n");
//		}//gsb
...
void OpalEchoCanceler::SentPacket(RTP_DataFrame& echo_frame, INT)
{
  ...
  if (param.m_mode == NoCancelation)
    return;
	////////////////////gsb added for audio test////////////////
//		int outputsize = 0;
//		outputsize = echo_frame.GetPayloadSize();
//		memcpy((unsigned char *)outBuf,echo_frame.GetPayloadPtr(), outputsize);
//		if(ne)
//		{
//			printf("send %d bytes\n",outputsize);
//			fwrite((unsigned char *)outBuf, 1, outputsize, ne);
//			fflush(ne);
//		}
//		return;
	////////////////////gsb added for audio test end ////////////////
...
////////////////////gsb added for audio test////////////////
//	inputSize = input_frame.GetPayloadSize();
//	memcpy((unsigned char *)inBuf,input_frame.GetPayloadPtr(), inputSize);
//	if(fa)
//	{
//		printf("recv %d bytes\n",inputSize);
//		fwrite((unsigned char *)inBuf, 1, inputSize, fa);
//		fflush(fa);
//	}
//return;//dong add for no cancel.
  ...
  {
	  printf("*********************************input_frame.GetPayloadPtr() =%d *************************************\n",input_frame.GetPayloadPtr());
