...
static const char * const DefaultMediaFormatOrder[] = {
  ...
  OPAL_G711_ULAW_64K,
  OPAL_G711_ALAW_64K,
  OPAL_G7221C_48k,//gaoshaobo added
  OPAL_G719_48K,
...
//dong the point to load g711codec and h241 description
OPAL_REGISTER_G711();
//OPAL_REGISTER_G722();
...
OpalProductInfo::OpalProductInfo(bool)
  ...
  , t35CountryCode(38)     // Country code for China 
  , t35Extension(0)       // No extension code for China
  , manufacturerCode(999)  // add by ljq
{
...
void OpalManager::OnDualEstablished(OpalConnection & connection)
{
}

//dong add for gk
void OpalManager::OnGKRegisterSuccess(PString gkIp)
{
}
void OpalManager::OnGKRegisterFail()
{
}
...
{
  return new RTP_UDP(params);	//note, lee
}
...
//dong add for dual notify
void OpalManager::OnClosedDualMediaStream(const OpalMediaStream & /*channel*/)
{
}
