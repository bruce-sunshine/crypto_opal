...
const PString & OpalMediaFormat::FrameRateOption()	 { static const PConstString s(PLUGINCODEC_OPTION_FRAME_RATE);               return s; }
...
//dong motify for tcp/telnet control
const PString & OpalMediaFormat::DecodeBitRateOption() { static const PConstString s(PLUGINCODEC_OPTION_DECODE_BIT_RATE); return s; }
...
const PString & OpalAudioFormat::AlsaInputOption()	 { static const PConstString s(PLUGINCODEC_OPTION_ALSA_INPUT);               return s; }
...
OpalAudioFormatInternal::OpalAudioFormatInternal(const char * fullName,
  ...
  : OpalMediaFormatInternal(fullName,
                            ...
                            timeStamp)
{
  AddOption(new OpalMediaOptionUnsigned(OpalAudioFormat::AlsaInputOption(), false, OpalMediaOption::NoMerge,  0, 0,10));
  if (rxFrames > 0)
...
{
 //dong motify for tcp/telnet control
	AddOption(new OpalMediaOptionUnsigned(OpalVideoFormat::DecodeBitRateOption(),  false, OpalMediaOption::NoMerge, maxBitRate,1000));
	AddOption(new OpalMediaOptionUnsigned(OpalVideoFormat::FrameRateOption(),               false, OpalMediaOption::NoMerge, 60,   1,  60));
	AddOption(new OpalMediaOptionUnsigned(OpalVideoFormat::FrameHeightOption(),              false, OpalMediaOption::AlwaysMerge, PVideoFrameInfo::HD1080Height,  16,  32767));
  AddOption(new OpalMediaOptionUnsigned(OpalVideoFormat::FrameWidthOption(),               false, OpalMediaOption::AlwaysMerge, PVideoFrameInfo::HD1080Width,   16,  32767));
